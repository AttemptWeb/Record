...
不论你使用哪一种方式，开发你的个人应用，最后都会回归到产品本身上。通过技术完成自己心目中的个人应用，将应用提供给用户，这个才是终极目标。（**技术只是手段，产品才是目标**）

大话就不多说了，我将自己最近的个人小程序放出来吧！[github: 个人小程序源码](https://github.com/HerryLo/wxSapp)。希望代码可以对大家有参考意义
