### 数据库
* [mongodb基本配置与操作](./mongodb基本配置与操作.md)

### 命令行
* [centos 命令行操作](./CentOS6命令行.md)

### nginx
* [使用CentOS 6搭建简易web服务器](./使用centos6搭建简易web服务.md)
* [centos的 node服务](./centos配置node服务.md)
* [前端开发对于node和nginx的那些事](./前端开发对于node和nginx的那些事.md)
